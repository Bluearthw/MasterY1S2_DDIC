...
create_constraint_mode -name 0100_mode\
   -sdc_files\
    [list ${::IMEX::libVar}/mmmc/alu.sdc]
create_analysis_view -name AV_0100_wc_rc125_setup -constraint_mode 0100_mode -delay_corner AV_0100_wc_rc125_setup_dc
create_analysis_view -name AV_0100_wc_rc125_hold -constraint_mode 0100_mode -delay_corner AV_0100_wc_rc125_hold_dc
create_analysis_view -name AV_0100_bc_rc0_hold -constraint_mode 0100_mode -delay_corner AV_0100_bc_rc0_hold_dc
